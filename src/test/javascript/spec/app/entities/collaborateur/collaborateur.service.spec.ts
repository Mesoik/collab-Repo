...
describe('Service Tests', () => {
  describe('Collaborateur Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Collaborateur(0, 'AAAAAAA', 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Collaborateur', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            date: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should update a Collaborateur', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            content: 'BBBBBB',
      ...
      it('should return a list of Collaborateur', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            content: 'BBBBBB',
      ...
      it('should delete a Collaborateur', async () => {
